...
class SemanticNetwork:
    ...
    def predecessor(self, prd, dsc):
        ...
        lparents = [d.relation.entity2 for d in ldeclartions if not isinstance(
            d.relation, Association)]
    ...
    def query_cancel(self, entity, association_name):
        ...
        lassoc = [d for d in ldeclartions if isinstance(
            d.relation, Association) and d.relation.name == association_name]
    ...
    def query_down(self, entity, association_name, child=False):
        ...
        lchildren = [d.relation.entity1 for d in ldeclartions if not isinstance(
            d.relation, Association)]
