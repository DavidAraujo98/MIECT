...
static GraphTopoSort *_create(Graph *g)
{
  ...
  // COMPLETAR
  // ...
  p = (GraphTopoSort *)malloc(sizeof(struct GraphTopoSort));
  p->marked = (int *)malloc(numVertices * sizeof(int));
  p->numIncomingEdges = (int *)malloc(numVertices * sizeof(int));
  p->vertexSequence = (int *)malloc(numVertices * sizeof(int));
  p->validResult = 1;
  p->numVertices = g->numVertices;
